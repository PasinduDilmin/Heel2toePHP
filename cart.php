...
<section class="products shopping-cart">
   ...
   <form action="" method="post" class="box">
	  ...
	  <input type="hidden" name="Category" value="<?= $fetch_cart['Category']; ?>">
      <a href="quick_view.php?pid=<?= $fetch_cart['pid']; ?>" >
	  <img src="uploaded_img/<?= $fetch_cart['image']; ?>" alt="">
	  </a>
      
      <div class="name"><b><?= $fetch_cart['name']; ?></b></div>
	  	<div class="name"><span>Size = <?= $fetch_cart['Size']; ?></span></div>
		<div class="name"><?= $fetch_cart['Category']; ?></div>
